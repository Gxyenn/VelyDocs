...
const BASE_URL = "https://gomunime.my.id";
const SOURCE = "Gomunime";
const ENDPOINT = "/api/gomunime/anime/:slug";
...
export default async function handler(req: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Failed to scrape Gomunime anime detail";
