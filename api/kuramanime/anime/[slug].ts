...
const ENDPOINT = "/api/kuramanime/anime/:slug";
...
const parseAnimeDetail = async (slug: string) => {
  ...
  return {
    title,
    japaneseTitle: infoMap.get("judul jepang") || null,
    synopsis,
    genres,
...
export default async function handler(req: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Failed to scrape Kuramanime anime detail";
