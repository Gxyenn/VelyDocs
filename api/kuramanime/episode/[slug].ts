...
const ENDPOINT = "/api/kuramanime/episode/:slug";
...
export default async function handler(req: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Failed to scrape Kuramanime episode";
