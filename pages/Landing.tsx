...
import { ArrowRight, Code2, Cpu, Zap, Activity, Box } from 'lucide-react';
  ...
  return (
    <div className="relative overflow-hidden bg-black min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="max-w-2xl mx-auto space-y-6 mb-12 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
            ...
            <p className="text-zinc-400 text-sm md:text-lg font-bold tracking-tight leading-relaxed px-4">
              VelyDocs is a high-performance, stateless API kernel designed for real-time metadata extraction. 
              Built for production ecosystems that demand zero-latency structured data.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom-10 duration-700 delay-200">
            <Link
              to="/docs"
              className="w-full sm:w-auto inline-flex items-center justify-center px-10 py-4 text-[11px] font-black rounded-xl text-black bg-white hover:bg-zinc-200 transition-all uppercase tracking-[0.2em] active:scale-95 shadow-xl shadow-white/5"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6 text-center md:text-left">
              ...
              <p className="text-zinc-500 text-sm md:text-base font-medium leading-relaxed">
                VelyDocs bypasses traditional database latency by utilizing a native DOM-traversal kernel. 
      ...
      <div className="py-32 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-zinc-500 mb-10 font-bold text-sm">Experience the raw power of the VelyDocs kernel today.</p>
          <Link
            to="/docs"
